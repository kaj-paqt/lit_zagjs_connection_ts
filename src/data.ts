...
export const tourDataWithEffect: StepDetails[] = [
  ...
  },
  {
    ...
    description: "Use them to change the context properties",
    target: () =>
      document.querySelector<HTMLElement>(".toolbar nav button:nth-child(1)"),
    actions: [
  ...
  },
  {
    ...
    description:
      "Use them to see the state of the tour. Click the Visualizer button to proceed.",
    target: () =>
      document.querySelector<HTMLElement>(".toolbar nav button:nth-child(2)"),
    actions: [
      { label: "Prev", action: "prev" },
      { label: "Next", action: "next" },
    ],
